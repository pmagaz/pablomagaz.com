...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 1000, replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 1250, replay: false });
		onvisible.add('#text09', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 1250, replay: false });
		onvisible.add('.buttons.style1', { style: 'blur-in', speed: 500, intensity: 5, threshold: 3, delay: 1375, replay: false });
		onvisible.add('#image02', { style: 'blur-in', speed: 750, intensity: 5, threshold: 3, delay: 1000, replay: false });
		onvisible.add('#image04', { style: 'blur-in', speed: 750, intensity: 5, threshold: 3, delay: 1125, replay: false });
		onvisible.add('#image07', { style: 'blur-in', speed: 750, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#image05', { style: 'blur-in', speed: 750, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#image06', { style: 'blur-in', speed: 750, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.icons.style1', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 1750, replay: false });
		onvisible.add('#copyrightText', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 1750, replay: false });
		onvisible.add('#image01', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 1000, replay: false });
		onvisible.add('h1.style4, h2.style4, h3.style4, p.style4', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 1250, replay: false });
